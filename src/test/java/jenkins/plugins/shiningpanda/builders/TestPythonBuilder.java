...
public class TestPythonBuilder extends ShiningPandaTestCase {
	...
	PythonBuilder before = new PythonBuilder(installation.getName(), CommandNature.SHELL.getKey(), "echo hello",
		true);
	...
	PythonBuilder builder = new PythonBuilder(installation.getName(), CommandNature.SHELL.getKey(), "echo hello",
		false);
	...
	PythonInstallation installation = configureCPython2();
	PythonBuilder builder = new PythonBuilder(installation.getName(), CommandNature.SHELL.getKey(),
	...
	PythonInstallation installation = configureCPython2();
	PythonBuilder builder = new PythonBuilder(installation.getName(), CommandNature.XSHELL.getKey(), "echo %HOME%",
		false);
	FreeStyleProject project = createFreeStyleProject();
	project.getBuildersList().add(builder);
	FreeStyleBuild build = project.scheduleBuild2(0).get();
