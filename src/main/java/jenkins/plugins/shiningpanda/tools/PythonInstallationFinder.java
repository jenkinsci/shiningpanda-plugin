...
public class PythonInstallationFinder {
	...
	candidates.put("MacPort-CPython-3.3", "/opt/local/Library/Frameworks/Python.framework/Versions/3.3");
	candidates.put("MacPort-CPython-3.4", "/opt/local/Library/Frameworks/Python.framework/Versions/3.4");
	...
	candidates.put("System-CPython-3.3", "/System/Library/Frameworks/Python.framework/Versions/3.3");
	candidates.put("System-CPython-3.4", "/System/Library/Frameworks/Python.framework/Versions/3.4");
	// Return candidates
	return candidates;
    }
