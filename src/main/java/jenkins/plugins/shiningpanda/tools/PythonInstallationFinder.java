...
public class PythonInstallationFinder {
	 ...
	 */
	public static List<PythonInstallation> configure() throws IOException,
		...
		Jenkins.getInstance()
				...
				.setInstallations(
						installations
								.toArray(new PythonInstallation[installations
										.size()]));
	...
	public static List<PythonInstallation> getInstallations()
		...
		for (String name : candidates.keySet()) {
			...
			if (Python.fromHome(new FilePath(new File(home))) != null)
				...
				installations.add(new PythonInstallation(name, home,
	...
	private static LinkedHashMap<String, String> getDarwinCandidates() {
		...
		// MacPort
		// candidates.put("MacPort-CPython-2.5",
		// "/opt/local/Library/Frameworks/Python.framework/Versions/2.5");
		candidates.put("MacPort-CPython-2.6",
				"/opt/local/Library/Frameworks/Python.framework/Versions/2.6");
		candidates.put("MacPort-CPython-2.7",
				"/opt/local/Library/Frameworks/Python.framework/Versions/2.7");
		candidates.put("MacPort-CPython-3.1",
				"/opt/local/Library/Frameworks/Python.framework/Versions/3.1");
		candidates.put("MacPort-CPython-3.2",
				"/opt/local/Library/Frameworks/Python.framework/Versions/3.2");
		candidates.put("MacPort-CPython-3.3",
				"/opt/local/Library/Frameworks/Python.framework/Versions/3.3");
		candidates.put("MacPort-CPython-3.4",
		...
		// System
		// candidates.put("System-CPython-2.4",
		// "/System/Library/Frameworks/Python.framework/Versions/2.4");
		// candidates.put("System-CPython-2.5",
		// "/System/Library/Frameworks/Python.framework/Versions/2.5");
		candidates.put("System-CPython-2.6",
				"/System/Library/Frameworks/Python.framework/Versions/2.6");
		candidates.put("System-CPython-2.7",
				"/System/Library/Frameworks/Python.framework/Versions/2.7");
		candidates.put("System-CPython-3.0",
				"/System/Library/Frameworks/Python.framework/Versions/3.0");
		candidates.put("System-CPython-3.1",
				"/System/Library/Frameworks/Python.framework/Versions/3.1");
		candidates.put("System-CPython-3.2",
				"/System/Library/Frameworks/Python.framework/Versions/3.2");
		candidates.put("System-CPython-3.3",
				"/System/Library/Frameworks/Python.framework/Versions/3.3");
		candidates.put("System-CPython-3.4",
				"/System/Library/Frameworks/Python.framework/Versions/3.4");
		// Return candidates
		return candidates;
	}
