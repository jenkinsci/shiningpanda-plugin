...
public class FilePathUtil {
     ...
     *
     * @param filePaths The list of files or directories to check
     ...
     *
     * @param filePaths The list of directories to check
     ...
     *
     * @param filePaths The list of files to check
