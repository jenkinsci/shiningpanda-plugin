...
public abstract class Command {
     ...
     *
     * @param command The content of the script to execute
     */
     ...
     *
     * @param ignoreExitCode true if the exit code must be ignored
     */
     ...
     *
     * @param dir The folder in which the script is created
     ...
     *
     * @param isUnix         Target execution platform
