...
public class BuildoutBuilder extends Builder implements Serializable
{
            ...
            IOException
    {
        ...
        // Does VIRTUALENV use distribute
        boolean vUseDistribute = true;
        ...
        if (virtualenv.isOutdated(workspace, interpreter, vUseDistribute, vSystemSitePackages))
            // A new environment is required
            if (!virtualenv.create(launcher, listener, workspace, pwd, environment, interpreter, vUseDistribute,
                    vSystemSitePackages))
    ...
    public static final class DescriptorImpl extends BuildStepDescriptor<Builder>
    {
        ...
        {
            return "/plugin/shiningpanda/help/builders/BuildoutBuilder/help.html";
        }
