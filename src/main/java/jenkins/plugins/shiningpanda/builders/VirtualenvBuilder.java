...
public class VirtualenvBuilder extends Builder implements Serializable {
	...
	public VirtualenvBuilder(String pythonName, String home, boolean clear,
			boolean systemSitePackages, String nature, String command,
	...
	public boolean perform(AbstractBuild<?, ?> build, Launcher launcher,
		...
		Virtualenv virtualenv = BuilderUtil.getVirtualenv(listener,
				workspace.getVirtualenvHome(home));
		...
		if (clear
				|| virtualenv.isOutdated(workspace, interpreter,
						systemSitePackages))
			// A new environment is required
			if (!virtualenv.create(launcher, listener, workspace, pwd,
					environment, interpreter, systemSitePackages))
	...
	public static final class DescriptorImpl extends
		...
		public String getHelpFile() {
			return Functions.getResourcePath()
					+ "/plugin/shiningpanda/help/builders/VirtualenvBuilder/help.html";
		}
